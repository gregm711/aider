    ...
    def cmd_chat_mode(self, args):
        ...
        show_formats = OrderedDict(
            [
                ...
                (
                    "large_context_retriever",
                    "Use a large context retriever model to identify which files will need to be edited.",
                ),
            ]
        )
...
"""
    ...
    def cmd_large_context_retriever(self, args):
        """Enter large context retriever mode to see surrounding code context. If no prompt provided, switches to large context retriever mode."""  # noqa
        return self._generic_chat_command(
            args, "large_context_retriever", placeholder=args.strip() or None
        )
